...
class StockDetailServiceTest {
	...
	@Test
	void updateAndDeleteStockTest() {
		List<SaleDetailsVO> list = new ArrayList<SaleDetailsVO>();

		list.add(new SaleDetailsVO(stockDetail.getStockName(), 2));
		stockDetailService.updateAndDeleteStock(list);
	}
