...
@SpringBootTest
public class StockDetailsVOTest {

	StockDetailsVO st = new StockDetailsVO();
	StockDetailsVO st1 = new StockDetailsVO(11, "MRX", 12);
	...
	@Test
	void testToString() {
		StockDetailsVO st= new StockDetailsVO(101, "abc", 10.0);
		assertEquals("StockDetailsVO(stockId=101, stockName=abc, stockValue=10.0)",st.toString());
	}
}
